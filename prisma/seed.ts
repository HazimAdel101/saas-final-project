...
async function main() {
  ...
  await prisma.productDetail.create({
    data: {
      ...
      features: '["Text generation","Language understanding","Code generation"]',
  ...
  await prisma.productDetail.create({
    data: {
      ...
      features: '["Templates for various designs","Easy drag and drop interface","Collaboration tools"]',
      language_id: english.id,
    },
  });
  ...
  await prisma.productDetail.create({
    data: {
      ...
      features: '["قوالب لتصاميم مختلفة","واجهة سحب وإفلات سهلة","أدوات للتعاون"]',
      language_id: arabic.id,
    },
  });
